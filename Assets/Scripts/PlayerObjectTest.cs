...
{/*
    ...
    private void RegisterNetworkMessages()
    {
        ...
        Debug.Log("PlayerObjectTest on register network");
    ...
    private void OnReceiveMovementMessage(NetworkMessage _message)
    {
        ...
        {
            Manager.Instance.ConnectedPlayers[_msg.targetPlayerID].GetComponent<PlayerObjectTest>().ReceiveMovementMessage(_msg.objectPosition, _msg.objectRotation, _msg.time);
        }
    }
